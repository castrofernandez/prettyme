...
describe('prettyme: highlighting HTML', function () {
  ...
  it('Compound', async function () {
    ...
    expect(result).to.equal('<div class="line"><span class="in-angle delimiter">&lt;</span><span class="in-angle tag open">div</span><span class="in-angle delimiter">&gt;</span><span class="in-angle delimiter">&lt;</span><span class="in-angle tag open">input</span> <span class="in-angle attribute">type</span><span class="in-angle delimiter">=</span><span class="in-angle value">"text"</span> <span class="in-angle delimiter">/&gt;</span>This <span class="attribute">is</span> <span class="attribute">a</span> <span class="attribute">text.</span><span class="in-angle delimiter">&lt;/</span><span class="in-angle tag close">div</span><span class="in-angle delimiter">&gt;</span></div>');
  });
});